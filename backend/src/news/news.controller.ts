...
export class NewsController {
  ...
  @Get('get-articles')
  public async FetchNews(): Promise<NewsAPIFetchData | Article[]> {
   ...
   */
  private async CreateArticle(article: NewsAPIArticleData): Promise<Article> {
    // Formater les données
    if (
      article.content != null &&
      article.content.includes('<ul><li></li><li></li><li></li></ul>')
    ) {
